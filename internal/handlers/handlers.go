...
import (
	...
	"github.com/shaynemeyer/go-bnb/internal/forms"
	...
	"github.com/shaynemeyer/go-bnb/internal/repository/dbrepo"
)
...
// Logout - logs user out and redirects to home page
...
// AdminDashboard - show admin dashboard page
...
// AdminShowReservation - shows a reservation details in the admin tool
...
// AdminPostShowReservation - updates a reservations details in the admin tool
...
// AdminReservationsCalendar - shows all reservation on a calendar in admin tool
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		// get the block map from session. Loop through entire map,
		// if we have an entry in the map that doesn't exist in our posted data,
		// and if the restriction id > 0, then it's a block we need to remove.
